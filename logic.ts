...
export const addContact = (answers: any) => {
    (async () => {
        try {
            const spinner = ora.default('Adding contact…').start();
...
export const getContact = (id: number) => {
    ( async ()=>{
        try {
            const spinner = ora.default('Fetching contact…').start();
...
export const updateContact= (contact: any) => {
    (async () => {
        try {
            const spinner = ora.default('Updating contact…').start();
...
export const deleteContact= (id: number) => {
    (async () => {
        try {
            const spinner = ora.default('Deleting contact…').start();
...
export const getContactList= () => {
    (async () => {
        try {
            const spinner = ora.default('Fetching All Contacts…').start();
